...
module.exports = {
	...
	run: async function(message) {
		...
		if(!this.voiceStreams.has(message.guild.id) || !message.guild.members.get(this.client.user.id).voiceChannel || !currentSong) return message.channel.send(':x: The bot isn\'t playing anything!');
