module.exports = {
	...
	run: async function(message, args, argsString) {
		...
		if(message.content.match(/(arze|254696880120791040|fbot|277411860125581312|lusid|210802688181534720|hitler|nazi|kkk|hydra|discord\.js|conf(useh)?|113349501212782592)/gi)) rating = 10;
