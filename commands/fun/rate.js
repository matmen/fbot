module.exports = {
	...
	run: async function(message, args, argsString) {
		...
		if(message.content.match(/(matmen|254696880120791040|fbot|277411860125581312|lusid|210802688181534720|conf(useh)?|113349501212782592|hitler|nazi|kkk|hydra|discord\.js)/gi)) rating = 10;
