module.exports = {
	...
	run: async function(message, args, argsString) {
		...
		if(message.content.match(/(matmen|254696880120791040|qing|qingveno|pik|pikka|278415093748989952|280776816698851328|fbot|277411860125581312|lusid|210802688181534720|conf(useh)?|113349501212782592|tvde|183678031376809984|hitler|nazi|kkk|hydra|discord\.js)/gi)) rating = 10;
